        ...
        <div className='flex justify-between items-center w-full mb-7'>
            ...
            <div className='flex justify-between items-center gap-5'>
                ...
                <div className='relative'>
                    <input type="search" placeholder='Type to search groups and products' className='w-50 md:w-80 pl-10 pr-4 py-2 w-50 border-2 border-gray-300 bg-white rounded-lg focus:outline-none focus:border-blue-500'/>
